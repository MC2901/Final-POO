...
public class Main {
    public static void main(String[] args) {
        ...
        // Creamos un ArrayList para almacenar los clientes
...
// Iteramos sobre los clientes en el ArrayList
        for (Client cliente : clientes) {
            if (cliente.getExpectedResult().equals(winner.get(0).getTeamName())) {
                cliente.addPoints();
                System.out.println(cliente.getClientName() + " ganaste el prode ");
            } else {
                System.out.println(cliente.getClientName() + " no ganaste el prode");
            }
        }
